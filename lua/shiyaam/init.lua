-- script for loading all lua files in this current directory
-- https://github.com/hallettj/dot-vim/blob/master/home/.config/nvim/lua/init_d/init.lua
